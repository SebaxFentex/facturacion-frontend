...
export class VentaComponent implements OnInit {
  ...
  agregarProducto() {
    this.ventaActual.push(this.facturaDetalleActual);
  ...
  actualizarCantidad(event: Event){
    ...
    this.facturaDetalleActual.valor = this.facturaDetalleActual.cantidad * this.facturaDetalleActual.producto.valorUnitario;
  }

  calcularTotal(){
    this.totalVentaActual = this.ventaActual.reduce((sum, act) => sum + act.valor, 0);
